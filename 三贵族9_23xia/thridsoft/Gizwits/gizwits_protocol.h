...
* @{
*/
#define PRODUCT_KEY "81670700359d447cac316ef8d0c15d3d"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "f5eb67fdc21649c399a347fa492bbf70"
...
* @{
*/
#define fan_button_BYTEOFFSET                    0
#define fan_button_BITOFFSET                     0
#define fan_button_LEN                           1
#define water_button_BYTEOFFSET                    0
#define water_button_BITOFFSET                     1
#define water_button_LEN                           1
#define led_button_BYTEOFFSET                    0
#define led_button_BITOFFSET                     2
#define led_button_LEN                           1
#define motov_button_BYTEOFFSET                    0
#define motov_button_BITOFFSET                     3
#define motov_button_LEN                           1
#define beep_button_BYTEOFFSET                    0
#define beep_button_BITOFFSET                     4
#define beep_button_LEN                           1

#define temperature_RATIO                         0.1
#define temperature_ADDITION                      0
#define temperature_MIN                           0
#define temperature_MAX                           1000
#define smoke_RATIO                         1
#define smoke_ADDITION                      0
#define smoke_MIN                           0
#define smoke_MAX                           20000
#define ethanol_RATIO                         0.0001
#define ethanol_ADDITION                      0
#define ethanol_MIN                           0
#define ethanol_MAX                           30000000
/**@} */
...
typedef struct {
  bool valuefan_button;
  bool valuewater_button;
  bool valueled_button;
  bool valuemotov_button;
  bool valuebeep_button;
...
typedef struct {
  uint8_t flagfan_button:1;
  uint8_t flagwater_button:1;
  uint8_t flagled_button:1;
  uint8_t flagmotov_button:1;
  uint8_t flagbeep_button:1;
} attrFlags_t;
